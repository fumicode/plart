<!DOCTYPE html><html><head><title>PLART STORY | LIFE IS ART！ アートがライフスタイルになるウェブマガジン</title><meta name="viewport" content="width=device-width, initial-scale=1">
...
<a class="twitter-timeline" data-height="600" data-dnt="true" href="https://twitter.com/plartjp">Tweets by plartjp</a> <script async src="//platform.twitter.com/widgets.js" charset="utf-8"></script></h2></div></div></div></div><div class="page__footer"><div class="footerBox"><a href="#" class="blackButton">PAGE TOP</a><h2 class="footerBox__siteTitle"><span class="siteTitle"> <img src="<?= get_stylesheet_directory_uri()?>/public/image/plart_logo3.png" alt="アートがライフスタイルになるウェブマガジン PLART"></span></h2><a href="/"><img src="<?= get_stylesheet_directory_uri()?>/public/image/plart_logo.png" class="footerBox__icon"></a><nav><?php wp_nav_menu( array(
